...
document.getElementById("event_start").innerHTML = "Fest starting in: ";
// The data/time we want to countdown to
var countDownDate1 = new Date("Nov 4, 2022 08:00:00").getTime();
...
document.getElementById("mins1").innerHTML = minutes1 + "M "; 
document.getElementById("secs1").innerHTML = seconds1 + "S "; 
    
// Display the message when countdown is over
if (timeleft1 < 0) {
    clearInterval(myfunc1);
    document.getElementById("event_start").innerHTML = "";
    ...
    document.getElementById("end1").innerHTML = "FEST HAS STARTED!";
}
}, 1000);
